...
export type AggregatedIndicatorsOutput = z.infer<typeof AggregatedIndicatorsSchema>;
...
export type WeatherAnalysisResponse = z.infer<typeof WeatherAnalysisResponseSchema>;
export type ProbabilityOutput = z.infer<typeof ProbabilitySchema>;
