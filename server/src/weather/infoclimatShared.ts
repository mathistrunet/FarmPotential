...
export const INFOCLIMAT_OBSERVATIONS_URL =
  process.env.INFOCLIMAT_API_BASE ?? 'https://www.infoclimat.fr/opendata/produits-stations.csv';
export const INFOCLIMAT_STATIONS_URL =
  process.env.INFOCLIMAT_STATIONS_URL ?? 'https://www.infoclimat.fr/opendata/stations.csv';
